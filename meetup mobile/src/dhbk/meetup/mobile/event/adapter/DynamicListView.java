...
public class DynamicListView extends ListView {
    ...
    public long mMobileItemId = INVALID_ID;
...
//                int count = 0;
//                for(EventObject oe : mEventObject) {
//                	count++;
//                	System.out.println("EVENT: " + count + " : " + oe.idevent + " : " + oe.title);
//                }
                break;
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mEventObject, originalItem, getPositionForView(switchView));
    ...
    public void setCheeseList(ArrayList<EventObject> mEventObject) {
